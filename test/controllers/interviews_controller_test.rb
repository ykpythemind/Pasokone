...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { inteviewed_at: @interview.inteviewed_at, person_id: @interview.person_id, staff_id: @interview.staff_id, text: @interview.text, title: @interview.title } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { inteviewed_at: @interview.inteviewed_at, person_id: @interview.person_id, staff_id: @interview.staff_id, text: @interview.text, title: @interview.title } }
